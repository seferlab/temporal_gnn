...
parser.add_argument('--adj_data',
                    ...
                    help='adj data path')
parser.add_argument('--gcn_true',
                    type=str_to_bool,
                    default=True,
                    help='whether to add graph convolution layer')
parser.add_argument('--buildA_true',
                    type=str_to_bool,
                    default=True,
                    help='whether to construct adaptive adjacency matrix')
parser.add_argument('--load_static_feature',
                    type=str_to_bool,
                    default=False,
...
parser.add_argument('--dilation_exponential',
                    type=int,
                    default=1,
...
if __name__ == "__main__":
    ...
    for i in [2, 5, 11]:
        ...
        print(
            log.format(i + 1, amae[i], armse[i], amape[i], smae[i], srmse[i],
                       smape[i]))
